    ...
    return <div className={`menu-wrapper ${phase}`}>
      <ul>
        <li className={`menu-item ${phase}`}>
          <a href="#main" onClick={() => this.handleClick(this._link1)} ref={this._link1} >Главная</a>
        </li>
        <li className={`menu-item ${phase}`}>
          <a href="#about" onClick={() => this.handleClick(this._link2)} ref={this._link2}>О компании</a>
        </li>
        <li className={`menu-item ${phase}`}>
          <a href="#projects" onClick={() => this.handleClick(this._link3)} ref={this._link3}>Проекты</a>
        </li>
        <li className={`menu-item ${phase}`}>
          <a href="#contact" onClick={() => this.handleClick(this._link4)} ref={this._link4}>Контакты</a>
        </li>
      </ul>
    </div>
  }
